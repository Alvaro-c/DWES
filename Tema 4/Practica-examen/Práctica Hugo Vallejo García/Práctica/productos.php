...
<body>
	...
	// Cargamos los productos de esa categoría (y mostramos descatalogados si hay cookie de descatalogado).
	$productos = cargar_productos_categoria($_GET['categoria'], isset($_COOKIE['descatalogado']));
	...
	if ($productos !== TRUE) {
		...
		echo "Esta categoría está vacía.";
	}
	?>
</body>
