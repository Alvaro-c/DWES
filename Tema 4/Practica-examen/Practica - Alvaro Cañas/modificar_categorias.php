...
if($categorias===false){
    ...
    echo "<tr><th>Nombre</th><th>Descripción</th><th>Descatalogado</th><th>Enlace</th></tr>";
    foreach ($categorias as $categoria) {
        $CodCat = $categoria['CodCat'];
        $nombre = $categoria['Nombre'];
        $descripcion = $categoria['Descripcion'];
        $catalogo = $categoria['Descatalogado'];
    ...
    echo "<table>"; //abrir la tabla
    echo "<tr><th>Nombre</th><th>Descripción</th><th>Catalogo</th></tr>";
    echo "<tr>
            <form action = 'modificar_categorias.php' method = 'POST'>
            <td><input name = ':nombre' value = ''></td>
            <td><input name = ':descripcion' value = ''></td>
            <td><input name = ':catalogo' value = ''></td>
