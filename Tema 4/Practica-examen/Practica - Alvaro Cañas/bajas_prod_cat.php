...
// Esto lo compruebo primero para categorias y después para productos
...
if (isset($_GET['seleccion']) && $_GET['seleccion'] == 'Categorias') {
    ...
    // If para comprobar si se muestran los prod. descatalogados o no.
    if (leer_cookie('descatalogado', 0) == 1) {
        // Si se quieren ver todos los productos, aprovecho la función cargar_productos_categoria()
