...
<body>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['Modificar'])) {
        ...
        if ($actualizado === TRUE) {
            ...
            // Compruebo también si se viene de la pag con todos los productos. Si es así, no muestro la categoría sino todos los prod.
            if (str_contains($_SERVER['HTTP_REFERER'], 'modificar_productos.php?categoria=')) {
    ...
    echo "<tr><th>Nombre</th><th>Descripción</th><th>Peso</th><th>Stock</th><th>Descatalogado</th></tr>";
    ...
    foreach ($productos as $producto) {
        if ($producto['Stock'] >= 0) {
            ...
            $catalogo = $producto['Descatalogado'];
            ...
            <td><input name = ':catalogo' value = '$catalogo'></td>            
