...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 21-01-2022 a las 19:04:39
...
(33, '2022-01-19 17:03:44', 0, 5),
(34, '2022-01-21 16:54:11', 1, 5),
(35, '2022-01-21 16:55:31', 1, 5),
(36, '2022-01-21 16:55:50', 0, 5),
(37, '2022-01-21 17:05:06', 1, 3);
...
(10, 'producto test', 'producto test', 10, 1, 1, 4);
...
--
ALTER TABLE `pedidos`
  MODIFY `CodPed` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;

--
-- AUTO_INCREMENT de la tabla `pedidosproductos`
--
ALTER TABLE `pedidosproductos`
  MODIFY `CodPredProd` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=49;
...
--
ALTER TABLE `productospendientes`
  MODIFY `CodPend` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
